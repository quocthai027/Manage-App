      ...
      body: Stack(
        children: [
          LottieBuilder.network(
            'https://lottie.host/3b4b9d8c-73a5-45b3-aa34-952e701a3db2/QWag1KQs1i.json',
            fit: BoxFit.cover,
          ),
          Container(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            colors: [
                              Color.fromARGB(255, 98, 215, 219),
                              Color.fromARGB(255, 143, 43, 209),
                            ],
                          ),
                        ),
                        child: Text(
